...
//    - ajout de l'affichage du nombre d'essais possibles
//    - ajout de la vérification que le nombre saisi est bien dans l'intervalle [nbMin..nbMax]
/*************************************************/
...
#include "../include/Partie.h"
    ...
    void CPartie::Jouer (CJoueur &un_joueur)
    {
        ...
        cout << this->nbEssaisMax << " essais possibles" << endl;
        cout << "-------------"<< endl;

        while (i < this->nbEssaisMax && gagne == false)
        {
